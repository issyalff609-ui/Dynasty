...
export const PART_TIME_HOURS_BANDS: {
...
export const PART_TIME_JOB_DEFINITIONS: PartTimeJobDefinition[] = [
  {
    title: "Waiter",
    minAge: 16,
    hourlyRangeGBP: [8, 12],
...
export const JOB_DEGREE_REQUIREMENTS: Partial<Record<string, Degree[] | "any">> = {
  Lawyer: ["Law"],
  Doctor: ["Medicine"],
...
export const JOBS_WITH_DEGREE_REQUIREMENT = new Set(
  Object.keys(JOB_DEGREE_REQUIREMENTS)
);
