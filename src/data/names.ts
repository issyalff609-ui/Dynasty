import type { Country, Gender, NamePool } from "../types/character";

export const NAME_POOL_WEIGHTS_BY_COUNTRY: Record<
  Country,
...
export const FIRST_NAMES_BY_NAME_POOL: Record<NamePool, Record<Gender, string[]>> = {
  English: {
    Male: [
...
export const LAST_NAMES_BY_NAME_POOL: Record<NamePool, string[]> = {
  English: [
